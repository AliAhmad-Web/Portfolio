...
import { FaCode, FaReact, FaPalette, FaGitAlt, FaLayerGroup, FaUniversalAccess, FaMobileAlt, FaStar } from 'react-icons/fa';
...
const skills = [
  ...
  { name: 'UI Development', icon: <FaLayerGroup />, description: 'Creating clean, responsive, and user-friendly interfaces with modern frontend technologies.' },
];
